...
class ProductSearchApp:
    def __init__(self, backend_endpoint):
        ...
        # self.intro_text = "Made with 😍 by Vikas Reddy, \n⭐Indian Institute of Technology Guwahati \n⭐Email - r.kapuluri@iitg.ac.in\n"
    ...
    def display_search_results(self, response):
        ...
        width = num_columns * 100
        height = num_rows * 30
        
        st.write("Search Results")
        # display Dataframe
        st.dataframe(df.style.background_gradient(cmap="Purples", axis=0), width, height, hide_index=False, column_config={
